...
💡 **اكتشف جميع أوامر البوت وكيفية عملها من خلال النقر على زر » 📚 الاوامر**

🔖 **لمعرفة كيفية استخدام هذا البوت ، يرجى النقر فوق » دليل الاستخدام❓**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "‹ أضـف البـوت لـمـجـمـوعـتـك ✅ ›",
                        url=f"https://t.me/{BOT_USERNAME}?startgroup=true",
                    )
                ],
                [InlineKeyboardButton("‹ ❓طـريـقـه الاسـتـخـدام ›", callback_data="cbhowtouse")],
                [
                    InlineKeyboardButton("‹ الاوامـر 📚 ›", callback_data="cbcmds"),
                    InlineKeyboardButton("‹ مـطـور الـبوت 🔰 ›", url=f"https://t.me/{OWNER_NAME}"),
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "<SOURCE JAK>", url=f"https://t.me/SH_YCO"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹ المبرمج جاك ›", url="https://t.me/Jac_kx"
                   ). 
                ]. 
                [
                InlineKeyboardButton(
                        "<المبرمج اسرائيل>", url="https://t.me/K_I_U1
                    )
                ],
            ]
        ),
